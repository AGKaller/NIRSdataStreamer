function [Optodes, Types] = Pig02_220524_18x7_Yo25
...
patches = {
    ...
    18 20 19 17 'neck_rect_a';
    19 17 18 20 'neck_rect_a';     %        S  S
    22 24 23 21 'neck_rect_a';
    23 21 22 24 'neck_rect_a';
    26 26 25 25 'neck_rect_a';
    30 28 27 29 'neck_rect_a';

    % neck square (18mm)^2
    17 17 18 18 'neck_sqr_45,135';
    20 20 19 19 'neck_sqr_45,135';
    22 22 21 21 'neck_sqr_45,135';
    23 23 24 24 'neck_sqr_45,135';
    28 26 25 27 'neck_sqr_45,135';
    32 28 27 31 'neck_sqr_45,135';

    % neck trapezoids
    17 18 20 19 'neck_trap1854_a';
    18 17 19 20 'neck_trap1854_a';
    22 21 23 24 'neck_trap1854_a';
    21 22 24 23 'neck_trap1854_a';
